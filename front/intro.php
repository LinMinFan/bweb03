    ...
    <div class="tab rb" style="width:87%;">
      <div style="background:#FFF; width:100%; color:#333; text-align:left">
        ...
        <p style="margin:3px">影片名稱 ：<?=$mv['name'];?>
          <input type="button" value="線上訂票" onclick="ff('orders&id=<?=$mv['id'];?>')" style="margin-left:50px; padding:2px 4px" class="b2_btu">
        </p>
        ...
        <p style="margin:3px">上映日期 <?=$mv['date'];?></p>
        ...
        <table width="100%" border="0">
          <tbody>
            <tr>
              <td align="center"><input type="button" value="院線片清單" onclick="ff('main')"></td>
            </tr>
          </tbody>
        </table>
      </div>
